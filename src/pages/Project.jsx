...
const projs=[
    {
        id: "helpseek",
        title: "helpNseek",
        copy: "Addressing the issue UCSD students have for lost valuables, the goal for this porject was to create a platform for students to communicate with one another. Students can make posts on the platform, specifying whether they have lost or found an item, find posts about their lost belongings by filtering the results, and message one another with appropriate restrictions.",
        bg: "#fff",
        accent: "#000",
        image: {example},
    },
